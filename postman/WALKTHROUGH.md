...
This guided run covers the admin/pipeline core. The collection has much more (all 96 endpoints, including the tenant-facing catalog, stores, config and pricing folders) — [`../docs/api-reference.md`](../docs/api-reference.md) documents each one.
