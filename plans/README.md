...
| 01 | [01-database.md](./01-database.md) | ✅ executed (amended: `external_id` moved to `tenant_base_product`; `pipeline_run.tenant_id` → text; `integration_database_connection.origin` added) | `01-database-schema.md` | 00 |
...
| 03 | [03-integration-data-source.md](./03-integration-data-source.md) | ✅ executed (ERP compose port remapped to `5435`; placeholder entity replaced by 14 A7Pharma entities under per-vendor folder) | `04-integration-data-source.md` | 00, 01, 02 |
