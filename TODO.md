...
- [ ] **Contagem de endpoints nas docs está 2 a menos** — `CONTROLLER_MAPPING.md` e `docs/api-reference.md` dizem 96; o tree tem 98 handlers (offset pré-existente, não introduzido pela cota de lojas). Também falta a seção de `GET /settings/offer-defaults` na referência.
