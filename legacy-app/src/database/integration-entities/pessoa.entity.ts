...
export class PessoaTypeormEntity {
  ...
  @Column({ type: 'char', length: 1, name: 'tipo', nullable: false, default: 'F' })
  public tipo: string;

  @Column({ type: 'varchar', length: 11, name: 'cpf', nullable: true })
  public cpf?: string;

  @Column({ type: 'timestamp', precision: 0, name: 'datanascimento', nullable: true })
  public datanascimento?: Date;

  @Column({ type: 'varchar', length: 15, name: 'identidade', nullable: true })
  public identidade?: string;

  @Column({ type: 'varchar', length: 10, name: 'siglaorgaoidentidade', nullable: true })
  public siglaorgaoidentidade?: string;

  @Column({ type: 'char', length: 1, name: 'sexo', nullable: false, default: 'N' })
  public sexo: string;
  ...
  @Column({ type: 'char', length: 1, name: 'estadocivil', nullable: false, default: 'N' })
  ...
  @Column({ type: 'varchar', length: 20, name: 'inscricaoestadual', nullable: true })
  public inscricaoestadual?: string;

  @Column({ type: 'varchar', length: 70, name: 'ramoatividade', nullable: true })
  ...
  @Column({ type: 'boolean', name: 'isentoinscricaoestadual', nullable: false, default: false })
  ...
  @Column({ type: 'boolean', name: 'suspendercobranca', nullable: false, default: false })
  public suspendercobranca: boolean;

  @Column({ type: 'char', length: 1, name: 'status', nullable: false, default: 'A' })
  public status: string;

  @Column({ type: 'varchar', length: 20, name: 'codigoexportacao', nullable: true })
  public codigoexportacao?: string;

  @Column({ type: 'varchar', length: 20, name: 'passaporte', nullable: true })
  public passaporte?: string;

  @Column({ type: 'char', length: 1, name: 'crmrecebernotificacao', nullable: false, default: '?' })
  public crmrecebernotificacao: string;

  @Column({ type: 'boolean', name: 'crmrecebersms', nullable: false, default: false })
  public crmrecebersms: boolean;

  @Column({ type: 'boolean', name: 'crmreceberemail', nullable: false, default: false })
  public crmreceberemail: boolean;

  @Column({ type: 'boolean', name: 'crmreceberligacao', nullable: false, default: false })
  ...
  @Column({ type: 'varchar', length: 14, name: 'inscricaomunicipal', nullable: true })
  public inscricaomunicipal?: string;

  @Column({ type: 'boolean', name: 'orgaopublico', nullable: false, default: false })
  public orgaopublico: boolean;

  @Column({ type: 'timestamp', precision: 0, name: 'datahoraalteracao', nullable: true })
  public datahoraalteracao?: Date;

  @Column({ type: 'bigint', name: 'usuarioalteracaoid', nullable: true })
  public usuarioalteracaoid?: number;

  @Column({ type: 'char', length: 1, name: 'atuacao', nullable: false, default: '?' })
  public atuacao: string;

  @Column({ type: 'varchar', length: 9, name: 'inscricaosuframa', nullable: true })
