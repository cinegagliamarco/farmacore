...
import { PrincipioAtivoTypeormEntity } from './principio-ativo.entity';

@Entity('produto', { schema: 'public' })
export class ProdutoTypeormEntity {
  ...
  @Column({ type: 'char', length: 1, name: 'listapis', nullable: false, default: 'A' })
  public listapis: string;

  @Column({ type: 'char', length: 1, name: 'tipopreco', nullable: false, default: 'L' })
  ...
  @Column({ type: 'char', length: 1, name: 'listadcb', nullable: false, default: '?' })
  public listadcb: string;

  @Column({ type: 'char', length: 1, name: 'tipo', nullable: false, default: 'M' })
  public tipo: string;

  @Column({ type: 'varchar', length: 6, name: 'unidade', nullable: false, default: 'UN' })
  public unidade: string;

  @Column({ type: 'char', length: 1, name: 'origemmercadoria', nullable: false, default: '0' })
  ...
  @Column({ type: 'char', length: 1, name: 'unidademedidamedicamento', nullable: false, default: '1' })
  public unidademedidamedicamento: string;

  @Column({ type: 'boolean', name: 'medicamentoinconsistente', nullable: false, default: false })
  public medicamentoinconsistente: boolean;

  @Column({ type: 'char', length: 1, name: 'origeminativacao', nullable: false, default: '?' })
  ...
  @Column({ type: 'char', length: 1, name: 'tributacaoproduto', nullable: false, default: 'M' })
  ...
  @Column({ type: 'varchar', length: 2, name: 'tiposped', nullable: false, default: '00' })
  public tiposped: string;

  @NumericColumn({ precision: 15, scale: 4, name: 'medicamentoquantidadeapresentacao', nullable: true })
  public medicamentoquantidadeapresentacao?: number;

  @Column({ type: 'boolean', name: 'usocontinuo', nullable: false, default: false })
  public usocontinuo: boolean;

  @Column({ type: 'bigint', name: 'vacinaid', nullable: true })
  public vacinaid?: number;

  @Column({ type: 'boolean', name: 'movimentacaofracionada', nullable: false, default: false })
  public movimentacaofracionada: boolean;

  @Column({ type: 'varchar', length: 3, name: 'codigonaturezareceita', nullable: true })
  public codigonaturezareceita?: string;

  @Column({ type: 'boolean', name: 'permitirrevisaofiscalautomatica', nullable: false, default: true })
  public permitirrevisaofiscalautomatica: boolean;

  @Column({ type: 'char', length: 1, name: 'tipomedicamento', nullable: false, default: '?' })
  public tipomedicamento: string;

  @Column({ type: 'boolean', name: 'isentoregistroms', nullable: false, default: false })
  public isentoregistroms: boolean;

  @Column({ type: 'varchar', length: 255, name: 'registromsmotivoisencao', nullable: true })
  public registromsmotivoisencao?: string;

  // Relationships
  @ManyToOne(() => FabricanteTypeormEntity, { nullable: false })
  @JoinColumn({ name: 'fabricanteid', referencedColumnName: 'id' })
  public fabricante: FabricanteTypeormEntity;

  // Self-referencing relationship for produto referencia
  @ManyToOne(() => ProdutoTypeormEntity, { nullable: true })
  @JoinColumn({ name: 'produtoreferenciaid', referencedColumnName: 'id' })
  public produtoReferencia?: ProdutoTypeormEntity;

  @OneToMany(() => EmbalagemTypeormEntity, (embalagem) => embalagem.produto)
  public embalagens: EmbalagemTypeormEntity[];

  @ManyToOne(() => PrincipioAtivoTypeormEntity, { nullable: true })
  @JoinColumn({ name: 'principioativoid', referencedColumnName: 'id' })
  public principioativo?: PrincipioAtivoTypeormEntity;
}
