...
@Entity({ name: 'embalagem', schema: 'public', synchronize: false })
...
export class EmbalagemEntity {
  ...
  @Column({
    type: 'timestamp',
    precision: 0,
    name: 'datahoraedicaocodigobarras',
    nullable: true,
  })
  ...
  public embalagemcontida?: EmbalagemEntity;

  @ManyToOne(() => ProdutoEntity, (produto) => produto.embalagens, {
    nullable: false,
  })
