...
@Entity({ name: 'custoproduto', schema: 'public', synchronize: false })
...
@Index(
  'uidx_custoproduto_produtoid_unidadenegocioid',
  ['produtoid', 'unidadenegocioid'],
  { unique: true },
)
export class CustoProdutoEntity {
  ...
  @Column({
    type: 'timestamp',
    precision: 0,
    name: 'datahorainiciocalculocustomedio',
    nullable: true,
  })
