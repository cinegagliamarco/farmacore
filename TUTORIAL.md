...
> - [`docs/api-reference.md`](./docs/api-reference.md) — complete per-endpoint API reference (all 96 endpoints: auth, roles, modules, bodies, errors)
...
The full HTTP surface (96 endpoints) is documented per endpoint in [`docs/api-reference.md`](./docs/api-reference.md) and covered by the Postman collection (next section). The curl snippets below cover the most common flows.
